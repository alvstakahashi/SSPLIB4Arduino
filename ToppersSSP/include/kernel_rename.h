 ...
 *  kernel_cfg.c
 */
extern const intptr_t	_kernel_tinib_exinf[];			/* タスクの拡張情報 */
extern       TASK    	_kernel_tinib_task[];			/* タスクの起動番地 */
extern const uint_t  	_kernel_tinib_epriority[];		/* タスクの実行時優先度先度（内部表現） */
