 ...
 *  カーネルの内部識別名のリネーム
 */
#include "include/kernel_rename.h"
...
extern void   tinib_task_set(int idx,TASK tsk);     /* タスクの起動番地 */
extern void cycinib_cychdr_set(int idx,CYCHDR hdr,RELTIM tout);
extern void alminib_almhdr_set(int idx,ALMHDR hdr);
